...
def test_question(driver, question_locator, answer_locator, expected_text):
    main_page = MainPage(driver)
    main_page.open()
    main_page.scroll_to_question(question_locator)
    main_page.click_question_button(question_locator)
    actual_text = main_page.visible_answer_text(answer_locator) 
    assert actual_text == expected_text, f"Expected answer text: '{expected_text}'"
